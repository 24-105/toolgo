...
export const aboutSections: LegalSection[] = [
  {
    ...
    paragraphs: [
      ...
      "本サイトは、ToolGoプロジェクトとして公開・保守しています。公開ソースコードと更新履歴は、次のGitHubリポジトリで確認できます。",
    ],
...
export const contactSections: LegalSection[] = [
  ...
  },
  {
    heading: "投稿時のお願い",
    paragraphs: [
      "公開Issueへ投稿する内容には、パスワード、個人情報、非公開の業務データなどの秘密情報を入力しないでください。",
...
export const privacySections: LegalSection[] = [
  {
    ...
    paragraphs: [
      ...
      "ToolGoのツール入力から、氏名、住所、メールアドレスなどの個人情報を直接取得することはありません。",
    ],
  },
  {
    heading: "2. ツールへの入力内容",
