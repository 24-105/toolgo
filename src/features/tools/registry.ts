...
const toolMetadata: ToolDefinition[] = [
  ...
  },
  {
    ...
    details: {
      overview:
        "NISA積立シミュレーターは、毎月の積立額、運用期間、想定年率から、将来の評価額と運用益の目安を計算するツールです。入力を少なくしたかんたんモードと、現在の運用額やボーナス投資を指定できる詳細モードを用意しています。",
      example:
        "毎月3万円を20年間、想定年率5%で積み立てたときの評価額と、積立元本との差を確認します。",
      howToUse: [
        "かんたんモードで毎月の積立額、運用期間、想定年率を入力します。",
        "全世界株式（オルカン）などの参考年率を選ぶか、想定年率を自分で入力します。",
        "必要に応じて詳細モードに切り替え、現在のNISA運用額やボーナス投資を追加します。",
  ...
  },
  {
    ...
    details: {
      overview:
        "投資信託の税引き後シミュレーターは、課税口座で毎月積み立てた場合の評価額と、計算した年に売却した場合の税引き後受取額を見積もるツールです。かんたんモードでは入力を少なくし、詳細モードでは現在の評価額・取得価額やボーナス投資を指定できます。",
      example:
        "毎月3万円を20年間、想定年率5%で積み立てたとき、売却時に税金を差し引くといくら受け取れるかを確認します。",
      howToUse: [
        "かんたんモードで毎月の積立額、運用期間、想定年率を入力します。",
        "全世界株式（オルカン）などの参考年率を選ぶか、想定年率を自分で入力します。",
        "すでに保有している資産を含める場合は、詳細モードで現在の評価額と取得価額を入力します。",
      ...
      faq: [
        ...
        },
        {
          ...
          answer:
            "正確に税金の目安を出すため、詳細モードで現在の評価額を入力する場合は、その保有分の取得価額も入力してください。税金は評価額ではなく、取得価額との差である利益をもとに計算します。",
        },
        {
  ...
  },
  {
    ...
    details: {
      ...
      howToUse: [
        ...
        "扶養配偶者がいる場合は指定し、詳細モードでは扶養親族の年齢、現在のiDeCo資産、企業年金等、国民年金基金等、手数料を追加します。",
